 ...
 */
final class Version20210325074759 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD compte_retrait_id INT NOT NULL, CHANGE compte_id compte_depot_id INT NOT NULL');
